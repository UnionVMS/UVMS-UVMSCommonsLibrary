...
public abstract class BaseDAOTest {
    ...
    private final String TEST_DB_URL = "jdbc:h2:mem:testdb;LOCK_TIMEOUT=10000;INIT=CREATE SCHEMA IF NOT EXISTS "+ getSchema() +";DATABASE_TO_UPPER=false;TRACE_LEVEL_SYSTEM_OUT=1;MVCC=true";
